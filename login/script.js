...
async function registerUser(email, username, password ) {
  try {
    const response = await fetch("https://api-floristeria.onrender.com/api/register/", {
      method: "POST",
      headers: { 
...
async function loginUser(username, password) {
  try {
    const response = await fetch("https://api-floristeria.onrender.com/api/login/", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    if (response.ok) {
      ...
      window.location.href = "https://api-floristeria.onrender.com/dashboard/index.html?#";
    } else {
...
function checkAuthentication() {
  ...
  if (!token) {
    ...
    window.location.href = "https://api-floristeria.onrender.com/login/index.html";
  }
}
